...
* [SPUD](https://github.com/sinbad/SPUD) ⭐ 609 | 🐛 16 | 🌐 C++ | 📅 2026-08-24 - Save game state and streaming level persistence solution.
...
* [SUQS](https://github.com/sinbad/SUQS) ⭐ 179 | 🐛 1 | 🌐 C++ | 📅 2026-07-20 - Data driven quest system.

### Locomotion

* [ALS-Community](https://github.com/dyanikoglu/ALS-Community) ⭐ 2,670 | 🐛 18 | 🌐 C++ | 📅 2024-07-10 - Replicated and optimized community version of Advanced Locomotion System V4.
...
* [Houdini Engine](https://github.com/sideeffects/HoudiniEngineForUnreal) ⭐ 1,601 | 🐛 114 | 🌐 C++ | 📅 2026-09-03 - A plugin to allow integration with Houdini Digital Assets workflows.
...
* [Voxel Plugin](https://github.com/Phyronnaz/VoxelPlugin) ⭐ 1,760 | 🐛 273 | 🌐 C++ | 📅 2026-06-24 - Create fully volumetric, entirely destructible, infinite worlds in Unreal Engine.
...
* [Action Roguelike](https://github.com/tomlooman/ActionRoguelike) ⭐ 4,577 | 🐛 2 | 🌐 C++ | 📅 2026-09-06 - Co-op action roguelike sample game built in Unreal Engine 5 and C++.
...
* [ALIS](https://github.com/fallintodusk/alis) ⭐ 15 | 🐛 5 | 🌐 C++ | 📅 2026-09-04 - In-development UE5 survival game built from real places, beginning with one reconstructed city location, with server-side MET-based metabolism and AGPL-3.0 C++ code.
...
* [UE5 Styleguide](https://github.com/Allar/ue5-style-guide) ⭐ 6,293 | 🐛 47 | 📅 2023-10-05 - Guidelines for making Unreal Engine projects more consistent.
* [GASDocumentation](https://github.com/tranek/GASDocumentation) ⭐ 5,944 | 🐛 44 | 🌐 C++ | 📅 2024-04-06 - Helps fill in the gaps of the official Gameplay Ability System documentation.
